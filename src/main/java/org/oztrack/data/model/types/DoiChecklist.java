...
public enum DoiChecklist {
    ...
    LICENCE(
            "Licence",
            "The project dataset is available under Creative Commons 0 Licence.",
            "ZoaTrack checks the licence that has been allocated to this project."),

    AUTHORS(
            "Authors",
            "Information about the authorship of the project have been added to ZoaTrack.",
    ...
    RESEARCH(
            ...
            "ZoaTrack checks that a contributor has a relationship with an Australian research institution."),
