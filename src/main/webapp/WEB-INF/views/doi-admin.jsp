...
<tags:page title="${project.title}: DOI Requests">
    ...
    <jsp:attribute name="breadcrumbs">
        ...
        &rsaquo; <span class="active">DOI Admin</span>
    </jsp:attribute>
    <jsp:body>
        <h1>ZoaTrack DOI Admin</h1>
        ...
        <table id="doi-admin-table" class="table table-condensed table-hover"
        data-page-length='10'
        ...
        <c:if test="${not empty doiList}">
            <c:set var="doiAdminUrl" value="${pageContext.request.contextPath}/settings/doi/${doi.id}"/>
            <c:choose>
            ...
            <tr class="clickable-row" data-url="${doiAdminUrl}">
