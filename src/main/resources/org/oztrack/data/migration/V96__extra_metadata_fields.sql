alter table project add column datamanipulation text;
alter table project add column locationaccuracycomments text;
alter table project add column licencingandethics text;

alter table animal add column speciesscientificname	text;
alter table animal add column speciescommonname     text;
alter table animal add column sex                   text;
alter table animal add column mass                  text;
...
alter table animal add column capturelocation       text;
